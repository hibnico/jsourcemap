...
public class Base64VLQ {
    ...
    /**
     * Converts from a two-complement value to a value where the sign bit is placed in the least significant bit. For
     * example, as decimals: 1 becomes 2 (10 binary), -1 becomes 3 (11 binary) 2 becomes 4 (100 binary), -2 becomes 5
     * (101 binary)
     */
    ...
    /**
     * Converts to a two-complement value from a value where the sign bit is placed in the least significant bit. For
     * example, as decimals: 2 (10 binary) becomes 1, 3 (11 binary) becomes -1 4 (100 binary) becomes 2, 5 (101 binary)
     * becomes -2
     */
    ...
    /**
     * Decodes the next base 64 VLQ value from the given string and returns the value and the rest of the string via the
     * out parameter.
     * 
     * @return
     */
